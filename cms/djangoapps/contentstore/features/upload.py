...
@step(u'I upload the( test)? file "([^"]*)" by clicking "([^"]*)"')
def upload_file_on_button_press(_step, is_test_file, file_name, button_text=None):
    upload_file(_step, is_test_file, file_name, button_text)
